...
public class Diableavionics_assumeControlStats2 extends MagicSubsystem {
    ...
    public Diableavionics_assumeControlStats2(ShipAPI ship) {super(ship);
    }
    ...
    public void onActivate() {
            ...
            for (ShipAPI fighter : getFighters(ship)) {
                ...
                //accelerate fighters
                float shipTimeMult = 1.25f;
                fighter.getMutableStats().getTimeMult().modifyMult(SYSTEM_ID, shipTimeMult);
                fighter.getMutableStats().getHullDamageTakenMult().modifyMult(SYSTEM_ID, 0.33f);
                fighter.getMutableStats().getArmorDamageTakenMult().modifyMult(SYSTEM_ID, 0.33f);
                fighter.getMutableStats().getShieldDamageTakenMult().modifyMult(SYSTEM_ID, 0.33f);
    ...
    public void onFinished() {
        ...
        for (ShipAPI fighter : getFighters(ship)) {
            if (fighter.isHulk()) continue;
            fighter.getMutableStats().getTimeMult().unmodify(SYSTEM_ID);
            fighter.getMutableStats().getHullDamageTakenMult().unmodify(SYSTEM_ID);
            fighter.getMutableStats().getArmorDamageTakenMult().unmodify(SYSTEM_ID);
            fighter.getMutableStats().getShieldDamageTakenMult().unmodify(SYSTEM_ID);
    ...
    public class ControlFighterSwitch extends MagicSubsystem {
