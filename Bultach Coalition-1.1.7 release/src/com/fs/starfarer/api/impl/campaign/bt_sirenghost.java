...
public class bt_sirenghost extends BaseSensorGhost {

	public bt_sirenghost(SensorGhostManager manager, SectorEntityToken target) {
		super(manager, 40);
		...
		getEntity().addScript(new com.fs.starfarer.api.impl.campaign.bt_sirencall_effect(getEntity(), 0.1f));
	}
}