...
public class bt_piercing_behavior extends BaseEveryFrameCombatPlugin {
	...
	private final float BASE_SPEED = 350f;
			...
			for (DamagingProjectileAPI Proj : engine.getProjectiles()){
				if (Proj != null){
					if (Proj.getCollisionClass() == CollisionClass.NONE && Proj.getWeapon() != null && Proj.getWeapon().getSpec() != null && !Proj.isFading()){
						...
						//THE GUN
						if (Proj.getWeapon().getSpec().hasTag("divine_cleaver")){
