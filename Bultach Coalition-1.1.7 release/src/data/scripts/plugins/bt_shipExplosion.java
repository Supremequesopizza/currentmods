...
public class bt_shipExplosion extends BaseEveryFrameCombatPlugin {
    ...
    private static final String DATA_KEY = "bt_shipExplosion";
    ...
    static {
        APPLICABLE_SHIPS.add("ork_sgr_main");

        CORE_OFFSET.put("ork_sgr_main", -50f);
    }
