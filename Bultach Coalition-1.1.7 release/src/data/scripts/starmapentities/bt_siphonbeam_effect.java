...
public class bt_siphonbeam_effect extends BaseCustomEntityPlugin {
    ...
    Object readResolve() {
        sprite = Global.getSettings().getSprite("campaignEntities", "bt_beam_core");
        glow = Global.getSettings().getSprite("campaignEntities", "bt_beam_glow");
        original = Global.getSettings().getSprite("campaignEntities", "bt_beam_core2");
        flare = Global.getSettings().getSprite("campaignEntities", "bt_flare_color2");
        return this;
    }
    ...
    public void render(CampaignEngineLayers layer, ViewportAPI viewport) {
        ...
        Color glowColor;
        //Fringe
        glowColor = new Color(255, 136, 0, 206);
        sprite.setSize(w / 1.5f, h);
        sprite.setAlphaMult(alphaMult);
        sprite.setAngle(entity.getFacing() - 90f);
        ...
        //Helix
        glowColor = new Color(255, 126, 126, 115);
        ...
        //Flare
        flare.setSize(200f * (0.9f + 0.3f * FlareSizeRandom) * 0.50f, 24f * (0.9f + 0.3f * FlareSizeRandom) * 0.75f);
