...
public class bt_siphon_planetary_effect extends BaseCustomEntityPlugin {
    ...
    Object readResolve() {
        glow = Global.getSettings().getSprite("campaignEntities", "bt_gasgiant_glow1");
        return this;
    }
    ...
    public void render(CampaignEngineLayers layer, ViewportAPI viewport) {
        ...
        Color glowColor = new Color(128, 255, 222, 206);
