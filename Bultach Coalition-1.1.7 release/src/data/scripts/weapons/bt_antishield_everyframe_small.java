...
public class bt_antishield_everyframe_small implements EveryFrameWeaponEffectPlugin {
    @Override
    ...
    private class shieldFukkerDamage implements DamageDealtModifier
    {
        ...
        public String modifyDamageDealt(Object param, CombatEntityAPI target, DamageAPI damage, Vector2f point, boolean shieldHit) {
            ...
            if (shieldHit && param instanceof DamagingProjectileAPI && target != null && target instanceof ShipAPI) {
                ...
                if(proj.getWeapon() != null && proj.getWeapon().getId().equals("ork_slug")) {
                    ShipAPI ship = (ShipAPI) target;
                    damage.setDamage(damage.getDamage() * (0.5f / ship.getShield().getFluxPerPointOfDamage()));
                }
            }
            return null;
        }
