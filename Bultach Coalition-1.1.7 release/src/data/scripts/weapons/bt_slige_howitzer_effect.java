...
public class bt_slige_howitzer_effect implements OnHitEffectPlugin, OnFireEffectPlugin, EveryFrameWeaponEffectPlugin,
        DamageDealtModifier {
    ...
    public void onFire(DamagingProjectileAPI projectile, WeaponAPI weapon, CombatEngineAPI engine) {
        ...
        if (!ship.hasListenerOfClass(bt_slige_howitzer_effect.class)) {
    ...
    public void onHit(DamagingProjectileAPI projectile, CombatEntityAPI target,
        ...
        engine.addNegativeParticle(point, vel, 50f, 0f, 0.5f, Color.black);
        engine.addNegativeParticle(point, vel, 30f, 0f, 0.5f, Color.black);
        engine.addNegativeNebulaParticle(point, vel, 30f, 2f, 0f, 0f, 0.5f, Color.black);
