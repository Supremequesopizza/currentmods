...
public class bt_fightertorp_OnHit implements OnHitEffectPlugin {
    ...
    static void explosion(Vector2f point, CombatEngineAPI engine, DamagingProjectileAPI projectile) {
        ...
        float CoreExplosionDuration = 0.5f;
        float ExplosionRadius = 150f;
        float ExplosionDuration = 0.75f;
        float CoreGlowRadius = 75f;
        float CoreGlowDuration = 0.5f;
        float GlowRadius = 350f;
        float GlowDuration = 0.75f;
        float FlashGlowRadius = 350f;
        ...
        Global.getSoundPlayer().playSound("emp_torpedo_impact", 1.4f + MathUtils.getRandomNumberInRange(-0.1f, 0.1f), 0.1f, point, ZERO);
