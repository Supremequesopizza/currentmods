 ...
 * @author Nicke535
 */
public class bt_doombeam_muzzleflash implements EveryFrameWeaponEffectPlugin {
    ...
    */
    ...
    static {
        ...
        ON_SHOT_PARTICLE_COUNT.put("HEAT1", 1);
        ON_SHOT_PARTICLE_COUNT.put("HEAT2", 2);
    }
    ...
    static {
        ...
        PARTICLES_PER_SECOND.put("GLOW1", 25f);
        PARTICLES_PER_SECOND.put("GLOW2", 25f);
        PARTICLES_PER_SECOND.put("STEAM1", 25f);
        PARTICLES_PER_SECOND.put("STEAM2", 25f);
        PARTICLES_PER_SECOND.put("STEAM3", 60f);
        PARTICLES_PER_SECOND.put("STEAM4", 60f);
    }
    ...
    static {
        ...
        AFFECTED_BY_CHARGELEVEL.put("GLOW1", true);
        AFFECTED_BY_CHARGELEVEL.put("GLOW2", true);
    }
    ...
    static {
        ...
        SIZE_AFFECTED_BY_CHARGELEVEL.put("GLOW1", true);
        SIZE_AFFECTED_BY_CHARGELEVEL.put("GLOW2", true);
    }
    ...
    static {
        ...
        PARTICLE_SPAWN_MOMENT.put("STEAM1", "COOLDOWN");
        PARTICLE_SPAWN_MOMENT.put("STEAM2", "COOLDOWN");
    }
    ...
    static {
        PARTICLE_SPAWN_POINT_TURRET.put("default", new Vector2f(0f, 80f));
        PARTICLE_SPAWN_POINT_TURRET.put("STEAM1", new Vector2f(27f, -40f));
        PARTICLE_SPAWN_POINT_TURRET.put("STEAM2", new Vector2f(-27f, -40f));
        PARTICLE_SPAWN_POINT_TURRET.put("STEAM3", new Vector2f(0f, -40f));
        PARTICLE_SPAWN_POINT_TURRET.put("STEAM4", new Vector2f(-0f, -40f));
    }
    ...
    static {
        PARTICLE_SPAWN_POINT_HARDPOINT.put("default", new Vector2f(0f, 80f));
    }
    ...
    static {
        ...
        PARTICLE_TYPE.put("STEAM1", "SMOKE");
        PARTICLE_TYPE.put("STEAM2", "SMOKE");
        PARTICLE_TYPE.put("STEAM3", "SMOKE");
        PARTICLE_TYPE.put("STEAM4", "SMOKE");
        PARTICLE_TYPE.put("FLASH", "EXPLOSION");
    }

    //What color does the particles have?
    private static final Map<String, Color> PARTICLE_COLOR = new HashMap<>();
    static {
        PARTICLE_COLOR.put("default", new Color(255, 255, 255, 255));
        PARTICLE_COLOR.put("GLOW1", new Color(213, 10, 10, 100));
        PARTICLE_COLOR.put("HEAT1", new Color(213, 10, 10, 100));
        PARTICLE_COLOR.put("STEAM1", new Color(255, 255, 255, 100));
        PARTICLE_COLOR.put("STEAM2", new Color(255, 255, 255, 100));
        PARTICLE_COLOR.put("STEAM3", new Color(255, 255, 255, 100));
        PARTICLE_COLOR.put("STEAM4", new Color(255, 255, 255, 100));
        PARTICLE_COLOR.put("FLASH", new Color(213, 10, 10, 255));
    }
    ...
    static {
        ...
        PARTICLE_SIZE_MIN.put("GLOW1", 150f);
        PARTICLE_SIZE_MIN.put("GLOW2", 75f);
        PARTICLE_SIZE_MIN.put("HEAT1", 500f);
        PARTICLE_SIZE_MIN.put("HEAT2", 250f);
        PARTICLE_SIZE_MIN.put("FLASH", 150f);
    }
    ...
    static {
        ...
        PARTICLE_SIZE_MAX.put("GLOW1", 150f);
        PARTICLE_SIZE_MAX.put("GLOW2", 75f);
        PARTICLE_SIZE_MAX.put("HEAT1", 500f);
        PARTICLE_SIZE_MAX.put("HEAT2", 250f);
        PARTICLE_SIZE_MAX.put("FLASH", 200f);
    }
    ...
    static {
        ...
        PARTICLE_VELOCITY_MIN.put("STEAM1", 1f);
        PARTICLE_VELOCITY_MIN.put("STEAM2", 1f);
        PARTICLE_VELOCITY_MIN.put("STEAM3", 25f);
        PARTICLE_VELOCITY_MIN.put("STEAM4", 25f);
    }
    ...
    static {
        PARTICLE_VELOCITY_MAX.put("default", 0f);
        PARTICLE_VELOCITY_MAX.put("STEAM1", 15f);
        PARTICLE_VELOCITY_MAX.put("STEAM2", 15f);
        PARTICLE_VELOCITY_MAX.put("STEAM3", 105f);
        PARTICLE_VELOCITY_MAX.put("STEAM4", 105f);
    }
    ...
    static {
        ...
        PARTICLE_DURATION_MIN.put("HEAT1", 0.6f);
        PARTICLE_DURATION_MIN.put("HEAT2", 0.6f);
        PARTICLE_DURATION_MIN.put("STEAM1", 1f);
        PARTICLE_DURATION_MIN.put("STEAM2", 1f);
        PARTICLE_DURATION_MIN.put("STEAM3", 1f);
        PARTICLE_DURATION_MIN.put("STEAM4", 1f);
        PARTICLE_DURATION_MIN.put("FLASH", 0.6f);
    }
    ...
    static {
        PARTICLE_DURATION_MAX.put("default", 0.05f);
        PARTICLE_DURATION_MAX.put("HEAT1", 1.2f);
        PARTICLE_DURATION_MAX.put("HEAT2", 1.2f);
        PARTICLE_DURATION_MAX.put("STEAM1", 1.8f);
        PARTICLE_DURATION_MAX.put("STEAM2", 1.8f);
        PARTICLE_DURATION_MAX.put("STEAM3", 1.8f);
        PARTICLE_DURATION_MAX.put("STEAM4", 1.8f);
        PARTICLE_DURATION_MAX.put("FLASH", 1.2f);
    }
    ...
    static {
        ...
        PARTICLE_ARC.put("STEAM1", 360f);
        PARTICLE_ARC.put("STEAM2", 360f);
        PARTICLE_ARC.put("STEAM3", 15f);
        PARTICLE_ARC.put("STEAM4", 15f);
    }
    ...
    static {
        ...
        PARTICLE_ARC_FACING.put("STEAM3", 180f);
        PARTICLE_ARC_FACING.put("STEAM4", 180f);
    }
    ...
    private void spawnParticles (CombatEngineAPI engine, WeaponAPI weapon, float count, String type, boolean anchorAlternation, Vector2f spawnPoint, Color color, float sizeMin, float sizeMax,
        ...
        while (Math.random() < counter) {
            ...
            switch (type) {
                case "SMOOTH":
                    engine.addSmoothParticle(spawnLocation, velocity, size, 0.8f, duration, color);
                    break;
                case "SMOKE":
                ...
                case "EXPLOSION":
                    ...
                    break;
                default:
                    engine.addHitParticle(spawnLocation, velocity, size, 4f, duration, color);
                    break;
            }
        }
    }
