...
public class bt_lub_ProjectileScript extends BaseEveryFrameCombatPlugin {
	...
	private static final float TARGET_REACQUIRE_RANGE = 700f;
	...
	private static final float TARGET_REACQUIRE_ANGLE = 60f;

	//How fast the projectile is allowed to turn, in degrees/second
	private static final float TURN_RATE = 50f;
	...
	private static final float INTERCEPT_ACCURACY_FACTOR = 0f;
	...
	private static final float GUIDANCE_DELAY_MIN = 0.9f;
	 ...
	 */
	public bt_lub_ProjectileScript(@NotNull DamagingProjectileAPI proj, CombatEntityAPI target) {
		this.proj = proj;
		this.target = target;
