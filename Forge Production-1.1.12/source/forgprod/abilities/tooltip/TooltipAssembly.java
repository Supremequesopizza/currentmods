...
public class TooltipAssembly {
    ...
    public static void assembleTooltip(CampaignFleetAPI fleet, TooltipMakerAPI tooltip, String name,
        ...
        boolean hasActiveModules = FleetwideProductionChecks.hasActiveModules() &&
                Forgeprod_DefaultCargo.active.getCommodityAmount(Forgeprod_DefaultCargo.TYPE_BASE_REQUIRED,Commodities.HEAVY_MACHINERY,fleet.getCargo()) >= 1;
    ...
    public static void addCannotForgeNoMachinery(CampaignFleetAPI fleet, TooltipMakerAPI tooltip) {
        float pad = 6f;
        Color negativeHighlight = Misc.getNegativeHighlightColor();
        if (Forgeprod_DefaultCargo.active.getCommodityAmount(Forgeprod_DefaultCargo.TYPE_BASE_REQUIRED,Commodities.HEAVY_MACHINERY,fleet.getCargo())/*fleet.getCargo().getCommodityQuantity(Commodities.HEAVY_MACHINERY)*/ >= 1) {
    ...
    public static void addExpandedInfo(CampaignFleetAPI fleet, TooltipMakerAPI tooltip, boolean isActive) {
        ...
        if (FleetwideProductionChecks.hasActiveModules() &&
                Forgeprod_DefaultCargo.active.getCommodityAmount(Forgeprod_DefaultCargo.TYPE_BASE_REQUIRED,Commodities.HEAVY_MACHINERY,fleet.getCargo())/*fleet.getCargo().getCommodityQuantity(Commodities.HEAVY_MACHINERY)*/ >= 1) {
