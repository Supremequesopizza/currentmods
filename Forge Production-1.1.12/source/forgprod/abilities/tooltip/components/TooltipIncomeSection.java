...
public class TooltipIncomeSection {
    ...
    private static void addProductionValues(TooltipMakerAPI tooltip, CampaignFleetAPI fleet, boolean isActive) {
        ...
        if (getFleetCapacityForType(fleet, ProductionType.METALS_PRODUCTION) >= 1) {
            ...
            boolean noOre = Forgeprod_DefaultCargo.active.getCommodityAmount(ProductionType.METALS_PRODUCTION,Commodities.ORE,fleet.getCargo()) < ORE_INPUT;
        ...
        if (getFleetCapacityForType(fleet, ProductionType.TRANSPLUTONICS_PRODUCTION) >= 1) {
            ...
            boolean noTransplutonicOre = Forgeprod_DefaultCargo.active.getCommodityAmount(ProductionType.TRANSPLUTONICS_PRODUCTION,Commodities.RARE_ORE,fleet.getCargo()) < TRANSPLUTONIC_ORE_INPUT;
        ...
        if (getFleetCapacityForType(fleet, ProductionType.FUEL_PRODUCTION) >= 1) {
            ...
            boolean noVolatiles = Forgeprod_DefaultCargo.active.getCommodityAmount(ProductionType.FUEL_PRODUCTION,Commodities.VOLATILES,fleet.getCargo()) < VOLATILES_INPUT;
        ...
        boolean hasOre = Forgeprod_DefaultCargo.active.getCommodityAmount(ProductionType.METALS_PRODUCTION,Commodities.ORE,fleet.getCargo()) > ORE_INPUT;//fleet.getCargo().getCommodityQuantity(Commodities.ORE) > ORE_INPUT;
        boolean hasTransplutonicOre = Forgeprod_DefaultCargo.active.getCommodityAmount(ProductionType.TRANSPLUTONICS_PRODUCTION,Commodities.RARE_ORE,fleet.getCargo()) > TRANSPLUTONIC_ORE_INPUT;//fleet.getCargo().getCommodityQuantity(Commodities.RARE_ORE) > TRANSPLUTONIC_ORE_INPUT;
        ...
        if (getFleetCapacityForType(fleet, ProductionType.SUPPLIES_PRODUCTION) >= 1) {
            ...
            boolean hasMetal = Forgeprod_DefaultCargo.active.getCommodityAmount(ProductionType.SUPPLIES_PRODUCTION,Commodities.METALS,fleet.getCargo())/*fleet.getCargo().getCommodityQuantity(Commodities.METALS)*/ > METALS_INPUT_SUPPLIES;
            boolean hasTransplutonics = Forgeprod_DefaultCargo.active.getCommodityAmount(ProductionType.SUPPLIES_PRODUCTION,Commodities.RARE_METALS,fleet.getCargo())/*fleet.getCargo().getCommodityQuantity(Commodities.RARE_METALS)*/ > TRANSPLUTONICS_INPUT_SUPPLIES;
        ...
        if (getFleetCapacityForType(fleet, ProductionType.MACHINERY_PRODUCTION) > 0) {
            ...
            boolean hasMetal = Forgeprod_DefaultCargo.active.getCommodityAmount(ProductionType.MACHINERY_PRODUCTION,Commodities.METALS,fleet.getCargo())/*/*fleet.getCargo().getCommodityQuantity(Commodities.METALS)*/ > METALS_INPUT_MACHINERY;
            boolean hasTransplutonics = Forgeprod_DefaultCargo.active.getCommodityAmount(ProductionType.MACHINERY_PRODUCTION,Commodities.RARE_METALS,fleet.getCargo())/*fleet.getCargo().getCommodityQuantity(Commodities.RARE_METALS)*/ > TRANSPLUTONICS_INPUT_MACHINERY;
            boolean hasInputs = hasMetal && hasTransplutonics;
            boolean producesDeficient = (hasMetal && (hasTransplutonicOre && producesTransplutonics))
                    || (hasTransplutonics && (hasOre && producesMetals));
            if (!hasInputs && (producesAllMaterials || producesDeficient)) {
        ...
        if (getFleetCapacityForType(fleet, ProductionType.HULL_PARTS_PRODUCTION) > 0) {
            ...
            boolean hasMetal = Forgeprod_DefaultCargo.active.getCommodityAmount(ProductionType.HULL_PARTS_PRODUCTION,Commodities.METALS,fleet.getCargo())/*fleet.getCargo().getCommodityQuantity(Commodities.METALS)*/ > METALS_INPUT_HULL_PARTS;
            boolean hasTransplutonics = Forgeprod_DefaultCargo.active.getCommodityAmount(ProductionType.HULL_PARTS_PRODUCTION,Commodities.RARE_METALS,fleet.getCargo())/*fleet.getCargo().getCommodityQuantity(Commodities.RARE_METALS)*/ > TRANSPLUTONICS_INPUT_HULL_PARTS;
            boolean hasSupplies = Forgeprod_DefaultCargo.active.getCommodityAmount(ProductionType.HULL_PARTS_PRODUCTION,Commodities.SUPPLIES,fleet.getCargo())/*fleet.getCargo().getCommodityQuantity(Commodities.SUPPLIES)*/ > SUPPLIES_INPUT_HULL_PARTS;
            boolean hasMachinery = Forgeprod_DefaultCargo.active.getCommodityAmount(ProductionType.HULL_PARTS_PRODUCTION,Commodities.HEAVY_MACHINERY,fleet.getCargo())/*fleet.getCargo().getCommodityQuantity(Commodities.HEAVY_MACHINERY)*/ > MACHINERY_INPUT_HULL_PARTS;
