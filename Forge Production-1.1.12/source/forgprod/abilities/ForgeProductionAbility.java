...
public class ForgeProductionAbility extends BaseToggleAbility {
    ...
    private boolean checkUsableCapacities() {
        // 1.1.2 note - disabled refresh call, might re-enable later if bugs appear.
        // This is called every frame - refreshing probably shouldn't be here,
        // as it is a bit on the costlier side.
        // FleetwideModuleManager.getInstance().refreshIndexes(getFleet());
