...
public class Sidebar {
    ...
    private static void addMachinerySection(TooltipMakerAPI machineryPanel) {
        ...
        CampaignFleetAPI fleet = Global.getSector().getPlayerFleet();
        float machineryPresent = Forgeprod_DefaultCargo.active.getCommodityAmount(Forgeprod_DefaultCargo.TYPE_BASE_REQUIRED,Commodities.HEAVY_MACHINERY,fleet.getCargo());
    ...
    private static void addRatioLine(TooltipMakerAPI sidebarPanel, CampaignFleetAPI fleet) {
        ...
        if (Forgeprod_DefaultCargo.active.getCommodityAmount(Forgeprod_DefaultCargo.TYPE_BASE_REQUIRED,Commodities.HEAVY_MACHINERY,fleet.getCargo()) < 1f) {
            ratioDesc = "";
        }
