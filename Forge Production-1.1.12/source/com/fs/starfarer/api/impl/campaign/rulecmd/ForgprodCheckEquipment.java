...
public class ForgprodCheckEquipment extends BaseCommandPlugin {
    ...
    private static boolean hasCommodity(Map<String, Integer> requiredRes, CargoAPI cargo, String commodity) {
        return Forgeprod_DefaultCargo.active.getCommodityAmount(Forgeprod_DefaultCargo.TYPE_MS_Event,commodity,cargo) >= requiredRes.get(commodity);//cargo.getCommodityQuantity(commodity) >= requiredRes.get(commodity);
    }
